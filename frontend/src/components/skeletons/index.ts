/**
 * Re-export all skeleton components for convenient imports.
 *
 * Usage:
 *   import { MessageCardSkeleton, ProfileCardSkeleton } from '@/components/skeletons';
 */
export { MessageCardSkeleton } from '@/components/messages/MessageCardSkeleton';
